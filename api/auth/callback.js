import { buildClearedStateCookie, buildConfigErrorMessage, buildPostAuthRedirectUrl, buildSessionCookie, buildSessionFromDaenProfile, exchangeDaenCallback, getAuthConfig, getCallbackQuery, readStateFromRequest } from '../_lib/auth.js';
...
export default async function handler(req, res) {
    ...
    try {
        ...
        redirect(res, 302, `${redirectUrl}&provider_error=${encodeURIComponent(error instanceof Error ? error.message : 'callback_failed')}`, [clearedStateCookie]);
    }
}
