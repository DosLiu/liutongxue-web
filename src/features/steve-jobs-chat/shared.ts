...
export type SteveJobsChatResolvedStatus = Exclude<SteveJobsChatServiceStatus, 'checking'>;
...
export const resolveSteveJobsChatServiceStatus = (
  status?: SteveJobsChatApiResponse['status'],
  mode?: SteveJobsChatApiResponse['mode'],
  fallbackStatus: SteveJobsChatResolvedStatus = 'offline'
): SteveJobsChatResolvedStatus => {
