...
const thirdLog = siteOpsSceneLogCollection.logs.find((log) => log.id === 'site-ops-2026-04-03-home-reset-stable-baseline');

if (!thirdLog || !thirdLog.detailContent) {
  throw new Error('Site ops 2026-04-03 log detail is missing.');
}
